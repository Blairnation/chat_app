            ...
            {/* <div className="row g-0">
              ...
              <div className="px-4 "> 
                ...
                {messages.map((message) =>
                  <Link 
                    to={"/inbox/" + message.sender_profile.id + "/"}
                    href="#"
                  ...
                  >
                    ...
                    {message.sender.id !== user_id && 
                      <img src={message.sender_profile.image} className="rounded-circle mr-1" style={{objectFit:"cover"}} alt="1" width={40} height={40}/>
                    }
                    {message.sender.id === user_id && 
                      <img src={message.reciever_profile.image} className="rounded-circle mr-1" style={{objectFit:"cover"}} alt="2" width={40} height={40}/>
                    }
                      <div className="flex-grow-1 ml-3">
                        <strong>
                          ...
                          {message.sender.id === user_id && 
                            (message.reciever_profile.fullname) 
                          }
                          </strong>
                        <div className="small">
